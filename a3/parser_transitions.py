...
def minibatch_parse(sentences, model, batch_size):
    ...
    # unfinished_parses = partial_parses[:]
    # start = 0
    # end = len(partial_parses) - 1
    # batch_size = min(batch_size, len(partial_parses))
    # while start < len(partial_parses):
    ...
    #             start += 1
    #             while unfinished_parses[end].is_complete():
    #                 end -= 1
    #                 start += 1
    #             unfinished_parses[i] = unfinished_parses[end]
    #             end -= 1
    #             if end <= batch_size - 2:
    #                 batch_size = end + 1
    #
